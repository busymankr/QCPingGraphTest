...
QCPing::QCPing(QObject *parent) : QObject(parent)
{
...
void QCPing::setIP(QString ip)
{
    m_IP = ip;
}

QString QCPing::getIP()
{
    return m_IP;
}
...
void QCPing::processStarted()
{
    qDebug() << "processStarted()";
}

bool QCPing::isWinEnOutputString(QString s, QString &r)
{
    Q_UNUSED(s);
    Q_UNUSED(r);
...
bool QCPing::isWinKrOutputString(QString s, QString &r)
{
    // 127.0.0.1의 응답: 바이트=32 시간<1ms TTL=128
    // 172.217.31.132의 응답: 바이트=32 시간=64ms TTL=113
...
bool QCPing::isLinuxEnOutputString(QString s, QString &r)
{
    // 64 bytes from 127.0.0.1: icmp_seq=1 ttl=64 time=0.099 ms
...
bool QCPing::checkOutputString(QString s, QString &r)
{
    QString tmp = "";
...
QStringList QCPing::convToLineByLine(QString s)
{
...
qlonglong QCPing::getResponseTime(QString s)
{
    // =123
    // <1
...
void QCPing::readyReadStandardOutput()
{
